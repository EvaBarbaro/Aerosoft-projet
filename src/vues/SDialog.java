...
public class SDialog extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public SDialog(String titre, String textDuDialogue, String textDuBoutonOUI, String textDuBoutonNon) {
		...
		gl_contentPanel.setVerticalGroup(
			gl_contentPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPanel.createSequentialGroup()
					.addComponent(txtpnCeciEstUn, GroupLayout.DEFAULT_SIZE, 206, Short.MAX_VALUE)
					.addContainerGap())
		);
