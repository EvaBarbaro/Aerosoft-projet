...
public class FicheSearchPilote extends JFrame implements ActionListener {
	/**
	 *
	 */
				...
				data.addMouseListener(new MouseAdapter() {
					...
					public void mousePressed(MouseEvent mouseEvent) {
						...
						if (mouseEvent.getClickCount() == 2 && table.getSelectedRow() != -1) {
							...
							pilote = (Pilote) piloteDao.get(id);
		
							if (pilote != null) {
								
								FicheModifPilote fm = new FicheModifPilote(pilote);
