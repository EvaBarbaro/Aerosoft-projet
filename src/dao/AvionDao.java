...
<<<<<<< HEAD
	...
	public Object get(Object id) {
		...
		try {
			...
			while (res.next()) {
				...
				avion = new Avion(res.getInt("NumAvion"), res.getString("typeAvion"),
						res.getString("baseAeroport"));
	...
	public void save(Object t, String[] params) {
		...
		try {
			...
			// Les points d'interogation vont prendre les info de stmt.setString() dans l'ordre par
			// rapport � la requete
...
>>>>>>> 826c18e90aeac7e1c74ee141a391a6b645c10c1b
}
